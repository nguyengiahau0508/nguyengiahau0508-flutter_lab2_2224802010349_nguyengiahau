...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: const ResponesiveHomePage());
  }
}

class ResponesiveHomePage extends StatelessWidget {
  const ResponesiveHomePage({super.key});

  static const colorCodes = (
    body: Color(0xFFE0E0E0),
    navigation: Color(0xFFBDBDBD),
    pane: Color(0xFF9E9E9E),
  );
